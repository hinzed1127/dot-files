---
description: Implement a feature step-by-step from plan.md, tdd-prompts.md, and todo.md using TDD, committing after each step
argument-hint: <directory containing the plan files>
---
